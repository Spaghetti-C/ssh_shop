...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="order.user.addr" type="text" value="<s:property value="model.user.name" />" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="order.user.username" type="text" value="<s:property value="model.user.addr" />" style="width:150px" />
								<br /> 

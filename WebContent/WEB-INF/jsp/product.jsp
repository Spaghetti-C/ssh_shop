...
<body>
	...
	<div class="container header">
		<div class="span5">
			<div class="logo">
				<a> <img href="${ pageContext.request.contextPath }/index.action"
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：<s:property value="model.shop_price" />元/份</strong> 参 考 价：
			...
			<form id="cartForm" action="${ pageContext.request.contextPath }/cart_addCart.action" method="post">
				...
				<div class="action">
					...
					<div class="buy">
						<input id="addCart" class="addCart" value="加入购物车" type="button" onclick="addCartFun()" />

...
<div class="span10 last">
		...
		<ul>
			<s:if test="#session.existUser == null">
				...
				<li id="headerRegister" class="headerRegister" style="display: list-item;">
					<a href="${pageContext.request.contextPath}/user_registPage">注册</a>|</li>
			</s:if>
			<s:else>
				<li id="headerLogin" class="headerLogin" style="display: list-item;">
				...
				<li id="headerRegister" class="headerRegister" style="display: list-item;">
					<a href="${pageContext.request.contextPath}/user_logout.action">退出</a>|</li>
			</s:else>
	...
	<div class="phone">
		客服热线: <strong>96666/52777777</strong>
	</div>
</div>
<div class="span24">
	<ul class="mainNav">
